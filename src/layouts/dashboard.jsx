...
import PracticeDetail from '@/pages/dashboard/practice-detail';
import Student from '@/pages/dashboard/student';
import PracticesParticipant from '@/pages/dashboard/practices-participant';
    ...
    <div className="min-h-screen bg-blue-gray-50/50">
      ...
      <div className="p-4 xl:ml-80">
        ...
        <Routes>
          ...
          <Route exact path="/practices/:practice_id/:participant" element={<PracticeDetail />} />
