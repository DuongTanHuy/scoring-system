...
import { AddProductDialog } from '@/sections/student/student-info-dialog';
import {
  ArrowLeftIcon,
  ArrowRightIcon,
  EyeIcon,
...
export default function Student() {
  ...
  return (
    <>
          ...
          <table className="w-full min-w-[640px] table-auto">
            ...
            <tbody>
              {practiceTableData.map(
                ({ img, name, email, gender, studentCode, phone, role, date, address }, key) => {
      ...
      <AddProductDialog open={view} handleClose={() => setView(false)} />
    </>
  );
}
